...
__global__ void build_tree(Tensor<long, 2> parent_list, Tensor<long, 2> selected_index, Tensor<int, 1> verified_seq_len,
        ...
        while(true){
            ...
            for(cur_position=0; cur_position<draft_token_num;cur_position++){
                printf("check equal: cur_position=%d,left=%ld, right=%ld, equal=%d\\n", cur_position,selected_index[bid][cur_position], token_idx,selected_index[bid][cur_position]==token_idx?1:0);
