...
class DataParallelController:
    ...
    def pre_radix_scheduler(self, req):
        ...
        if max(prefix_lens) <= 100:
            ...
            forward_mems = [(availiable - occipuied - evictbale) if True else (-10000000) for availiable, occipuied, no_wait, evictbale in zip(self.main_available_kv_cache, occipuied_lens, no_waiting, self.main_evictable_kv_cache)]
