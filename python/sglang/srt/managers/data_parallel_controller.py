...
class DataParallelController:
    ...
    def pre_radix_scheduler(self, req):
        ...
        if max(prefix_lens) <= 100 or all_waiting:
            ...
            forward_mems = [(availiable - occipuied - evictbale) for availiable, occipuied, no_wait, evictbale in zip(self.main_available_kv_cache, occipuied_lens, no_waiting, self.main_evictable_kv_cache)]
