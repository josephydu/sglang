...
RES_FILE="test_res_method_${current_time}.log"
...
for random_input_len in 32 128 256 512 1024 2048 4096; do
    for random_output_len in 128 256 512 1024 2048 4096; do
        ...
        for method in "${!settings[@]}"; do
            ...
            # 循环从 16 到 20，步进为 0.1
            echo "Running with setting: $setting ======================================================" >> "$RES_FILE"
